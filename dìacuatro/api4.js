        ...
        navigator.geolocation.getCurrentPosition(posicion => {
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    futureDate.setDate(futureDate.getDate() + 3); // Ajustar la fecha para cuatro días después
                    ...
                    if (futureData) {
                        ...
                        // Reemplazar el texto del primer div con las 3 primeras letras del tercer día antes del actual
                        document.querySelectorAll('.botons')[0].textContent = tercerDiaAntesValor.slice(0, 3);
                        ...
                        // Reemplazar el texto del segundo div con las 3 primeras letras del día dos días antes del actual
                        document.querySelectorAll('.botons')[1].textContent = dosDiasAntesValor.slice(0, 3);
                        ...
                        // Reemplazar el texto del tercer div con las 3 primeras letras del día anterior al actual
                        document.querySelectorAll('.botons')[2].textContent = diaAnteriorValor.slice(0, 3);

                        // Obtener el día actual
                        let diaActualValor = traducciones[diaHora.toLocaleDateString('en-US', { weekday: 'long' })];

                        // Reemplazar el texto del cuarto div con las 3 primeras letras del día actual
                        document.querySelectorAll('.botons')[3].textContent = diaActualValor.slice(0, 3);
                        ...
                        // Reemplazar el texto del quinto div con las 3 primeras letras del día siguiente al actual
                        document.querySelectorAll('.botons')[4].textContent = diaSiguienteValor.slice(0, 3);
                        ...
                        // Reemplazar el texto del sexto div con las 3 primeras letras del día dos días después del actual
                        document.querySelectorAll('.botons')[5].textContent = dosDiasDespuesValor.slice(0, 3);
